...
export function Navbar() {
  ...
  const acceptedTasks = tasks?.filter(task => task.status === "accepted").length || 0;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2">Agent Escrow</span>
              </div>
              ...
              <div className="hidden md:flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-foreground font-bold text-accent">{totalTasks}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-muted-foreground">Accepted:</span>
                  <span className="text-foreground font-bold text-accent">{acceptedTasks}</span>
                </div>
              </div>
