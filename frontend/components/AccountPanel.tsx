...
import { useTasksByWorker } from "@/lib/hooks/useAgentEscrow";
...
export function AccountPanel() {
  ...
  const { data: workerTasks = [] } = useTasksByWorker(address);
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        <DialogContent className="brand-card border-2">
          <DialogHeader>
            ...
            <DialogDescription>
              Connect your MetaMask wallet to create or complete tasks
            </DialogDescription>
          </DialogHeader>
